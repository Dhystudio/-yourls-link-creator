	...
	public static function sidebox_about() { ?>
		...
		<div id="yourls-admin-about" class="postbox yourls-sidebox">
			...
			<div class="inside">
				...
				<?php echo sprintf( __( 'Talk to <a href="%s" class="external">@dhystudio</a> on twitter or visit the <a href="%s" class="external">plugin support forum</a> for bugs or feature requests.', 'wpyourls' ), esc_url( 'https://twitter.com/dhystudio' ), esc_url( 'https://wordpress.org/support/plugin/yourls-link-creator/' ) ); ?></p>

				<p><strong><?php _e( 'Enjoy the plugin?', 'wpyourls' ); ?></strong><br />

				<?php echo sprintf( __( '<a href="%s" class="admin-twitter-link">Tweet about it</a> and consider donating.', 'wpyourls' ), 'http://twitter.com/?status=I\'m using @dhystudio\'s YOURLS Link Creator plugin - check it out! http://l.norc.co/yourls/' ); ?>
		...
		<div id="yourls-admin-links" class="postbox yourls-sidebox">
			...
			<div class="inside">
				<ul>
					...
					<li><a href="https://github.com/Dhystudio/yourls-link-creator/" target="_blank"><?php _e( 'Plugin on GitHub', 'wpyourls' ); ?></a></li>
